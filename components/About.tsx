...
const About = () => {
    return (
        <div className='my-5 relative min-h-screen bg-aboutBg bg-cover bg-no-repeat px-20 flex items-center text-white'>
            {/* Background overlay between image and content */}
            <div className='absolute inset-0 bg-black opacity-60 z-0' />

            {/* Content section above overlay */}
            <div className='flex flex-col gap-5 relative z-10'>
                <h1 className='text-[38px] font-semibold'>Who are we?</h1>
                <p className='max-w-[650px] text-[17px]'>
